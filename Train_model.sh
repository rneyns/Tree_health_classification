...
python -u Train_model.py  -i "/data/brussel/104/vsc10421/onedrive/hydra-sync/output_patches" -multi "/data/brussel/104/vsc10421/onedrive/hydra-sync/5 species and other" -lh "species_code" -idh "tree_id" -nc 6 -ResNetV 0 --dataset TREES --modulation_ends 100 --alpha 0.5 --fusion_method "concat" --optimizer "Adam"  --task 'multiclass'  --learning_rate 0.0001 --lr_decay_step 10