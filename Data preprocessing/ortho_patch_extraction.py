...
def cut_patch_from_tile(tile_path, central_lon, central_lat, patch_size_m=12):
    """
...
if __name__ == "__main__":
    shapefile = '/Users/robbe_neyns/Documents/Work_local/research/UHI tree health/Data analysis/Tree mapping/Tree locations/Brussels Environment Layers/mobiliteit_shape_manual_adjustment_project/mobiliteit_shape_manual_adjustment_X_Y.shp'  # Path to the shapefile with coordinates
    ...
    #shapefile = '/Users/robbe_neyns/Documents/Work_local/research/UHI tree health/Data analysis/Tree mapping/extraction street trees/extracted_trees_10m.shp'
    tiles_folder = '/Users/robbe_neyns/Documents/Work_local/research/UHI tree health/ortho data/merged_tiles'  # Path to the folder containing the ortho tiles
    output_folder = "/Users/robbe_neyns/Documents/research/UHI tree health/output_patches_big"
