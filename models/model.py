...
class Attention(nn.Module):  ## this is where the attention module is actually implemented, so elegant... so simple...
    def __init__(
        ...
        self.to_qkv = nn.Linear(dim, inner_dim * 3, bias=False,
                                dtype=torch.float32)  ## A linear layer that projects the input feature vector into queries, keys, and values. The output dimension is three times the inner_dim because it includes separate projections for queries, keys, and values concatenated together.
